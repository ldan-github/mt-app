<template>
  <div class="m-life">
    <el-row>
      <ul class="nav">
        <li>
          <router-link to="/" class="apartment">美团外卖</router-link>
        </li>
        <li>
          <router-link to="/" class="taleout">猫眼电影</router-link>
        </li>
        <li>
          <router-link to="/" class="taleout">美团酒店</router-link>
        </li>
        <li>
          <router-link to="/" class="apartment">名宿/公寓</router-link>
        </li>
        <li>
          <router-link to="/" class="taleout">商家入驻</router-link>
        </li>
        <li>
    ...
    <el-row>
      ...
      <el-col :span="6">
        <div class="m-life-login">
          ...
          <p v-if="$store.state.userName == '请登录'">
